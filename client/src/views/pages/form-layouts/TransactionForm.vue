...
<template>
  <VForm ref="myForm" @submit.prevent>
    <VRow>
      ...
      <!-- 👉 Quantity -->
      <VCol cols="12" md="6">
        <VTextField v-model="transaction.quantity" label="Quantité" placeholder=""
          :style="{ color: 'rgb(73, 249, 3) !important' }" min="0" required type="number" />
      </VCol>
      ...
      <!-- 👉 Total -->
      <VCol cols="12" md="6">
        <VTextField v-model="transaction.total" label="Total" placeholder=""
          :style="{ color: 'rgb(73, 249, 3) !important' }" readonly type="number" />
      </VCol>

      <!-- 👉 +/- Value -->
      <VCol cols="12" md="6">
        <VTextField v-model="transaction.pl" label="+/- Value" placeholder=""
          :style="{ color: 'rgb(73, 249, 3) !important' }" readonly type="number" />
      </VCol>
      <!-- 👉 TotalGain -->
      <VCol cols="12" md="12">
        <VTextField v-model="transaction.totalgain" label="Total + Gain" placeholder="" readonly
          :style="{ color: 'rgb(73, 249, 3) !important' }" type="number" />
      </VCol>
      <!-- 👉 TotalGain -->
      <VCol cols="12" md="6">
        <VTextField v-model="transaction.tax" label="Commision" placeholder="" readonly
          :style="{ color: 'rgb(73, 249, 3) !important' }" type="number" />
      </VCol>

      <!-- 👉 TotalGain -->
      <VCol cols="12" md="6">
        <VTextField v-model="transaction.taxtva" label="TVA" placeholder="" readonly
          :style="{ color: 'rgb(73, 249, 3) !important' }" type="number" />
      </VCol>
